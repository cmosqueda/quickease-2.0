  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex flex-row justify-between items-center">
        ...
        <details className="dropdown dropdown-end">
          <summary className="list-none cursor-pointer">
            <EllipsisVertical
              className="rounded-full grow shrink-0 p-2 border border-gray-200 bg-white"
              size={36}
            />
          </summary>
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="flex flex-row gap-2 py-4 px-6 rounded-3xl bg-white border border-gray-200 cursor-pointer transition-all delay-0 duration-300 hover:bg-gray-100">
          <MessageCircle />
          <p>2</p>
        </div>
      </div>
